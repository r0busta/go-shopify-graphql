...
func (m *MockMetafieldService) Delete(arg0 context.Context, arg1 model.MetafieldDeleteInput) error {
	m.ctrl.T.Helper()
...
func (m *MockMetafieldService) DeleteBulk(arg0 context.Context, arg1 []model.MetafieldDeleteInput) error {
	m.ctrl.T.Helper()
